...
const createMockJob = (jobAvatar, jobTitle, jobDescription, jobTags) =>{
    return {
        jobId: ++indexCalc,
        jobAvatar: jobAvatar,
        jobTitle: jobTitle,
...
const MockedData = [
    createMockJob(Organization1, "Barber in BarberShop", "BarberShop provides a wide array of men's haircuts and styles for a diverse clientele.", "Barber, fulltime"),
    createMockJob(Organization2, "Front End Developer in Saturated Development", "Saturated Development network is a curated group of some of the fastest growing startups and tech companies in the country.", "IT, devoper, remote, fulltime"),
    createMockJob(Organization3, "Assistant Manager in WapeNash", "WapeNash is immediately hiring a full-time Assistant Store Manager to join our team in Alameda, California!", "Management, urgently hiring"),
    createMockJob(Organization4, "Secret Shakespearean Club", "If you are a person in constant motion, a motivated, enthusiastic, go-getter who enjoys a fast-paced team environment laced with challenges and opportunities, you are coming to the right place, come join a FUN team - APPLY TODAY!", "Part-time")
]

const createJobProfile = (jobAvatar, jobTitle, jobOffer, jobLocation, jobDescription, jobField, jobSkills, jobSalary) =>{
    return {
        jobAvatar: jobAvatar,
        jobTitle: jobTitle,
        jobOffer: jobOffer,
...
const MockedJobProfile = [
    ...
    "Salary: $122,151.00 - $132,833.00 per year"),
    ...
    "Salary: $63,100.00 - $100,700.00 per year"),
